                ...
                case VRCAvatarParameterDriver l:
                    {
                        ...
                        l.parameters = d.parameters.ConvertAll(p => {
                            ...
                            return new VRC_AvatarParameterDriver.Parameter {
                                ...
                                source = p.source, sourceParam = p.sourceParam, sourceMin = p.sourceMin, sourceMax = p.sourceMax, destParam = p.destParam, destMin = p.destMin, destMax = p.destMax, convertRange = p.convertRange };
                        });
                        break;
                    }
